...
<p>
    <?php 
        ...
        echo $this->Html->link('Agregar Usuarios', array('controller' => 'users', 'action' => 'add')); 
        
        echo "<br>";

        echo $this->Html->link('Lineas', array('controller' => 'lineas', 'action' => 'index')); 
	    
	    echo "<br>";

        echo $this->Html->link('Empresas', array('controller' => 'empresas', 'action' => 'index')); 
        echo "<br>";
        echo $this->Html->link('Unidades', array('controller' => 'unidades', 'action' => 'index')); 
